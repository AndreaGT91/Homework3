...
function getPasswordLength() {
  ...
  while (!isValidLength) {
    pwdLength = prompt("How many characters would you like in your password (8-12)?");
...
function generatePassword() {
  var newPwd = ''; // This will be the value that the function returns
  ...
  newPwd = createPassword(pwdLength,hasLower,hasUpper,hasNumeric,hasSpecial);
